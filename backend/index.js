...
const cors = require("cors");//cross origin resource sharing it restricts web page from making request to a different domain, but enable you to allow requests from other domain
